...
Descripcion : Se trata de una version sencilla del algoritmo de Cesar
Compilacion : gcc cesar.c -o cesar
Run         : ./cesar
...
/*Definicion de funciones, he decidido dejarlas tal cual el algoritmo de Vigenere, ya
  que Cesar es un caso especial de Vigenere donde el desplazamiento es 3*/
int   mod(int, int);
